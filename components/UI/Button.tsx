...
export const Button: React.FC<ButtonProps> = ({
  ...
  const getButtonStyles = (): ViewStyle => {
    ...
    switch (variant) {
      case 'primary':
        btnStyle.backgroundColor = theme.colors.primary[500];
        break;
      case 'secondary':
        btnStyle.backgroundColor = theme.colors.background.tertiary;
        break;
      case 'outline':
        btnStyle.backgroundColor = 'transparent';
        btnStyle.borderWidth = 1;
        btnStyle.borderColor = theme.colors.primary[500];
        break;
      case 'ghost':
        btnStyle.backgroundColor = 'transparent';
        break;
  ...
  const getTextStyles = (): TextStyle => {
    ...
    switch (variant) {
      case 'primary':
        txtStyle.color = theme.colors.text.inverse;
        break;
      case 'secondary':
        txtStyle.color = theme.colors.text.primary;
        break;
      case 'outline':
      case 'ghost':
        txtStyle.color = theme.colors.primary[500];
        break;
    }
  ...
  const renderContent = () => {
    if (isLoading) {
      return <ActivityIndicator color={variant === 'primary' ? theme.colors.text.inverse : theme.colors.primary[500]} />;
    }
