  ...
  <View style={styles.sectionContainer}>
    ...
    >
      ...
      <View style={styles.sectionBadge}>
        {isPrivate ? <Lock size={16} color={Colors.primary[400]} /> : <BookOpen size={16} color={Colors.success} />}
    ...
    <View style={styles.container}>
      <GradientBackground colors={[Colors.background.dark, Colors.background.darker]}>
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          >
            <GradientCard 
              colors={isRunning ? Colors.gradients.accent : Colors.gradients.warmDark}
              style={styles.timerCard}
            >
              <View style={styles.timerHeader}>
                <View style={styles.timerIconContainer}>
                  <Timer size={24} color={Colors.primary[400]} />
                </View>
                <Text style={styles.timerTitle}>Çalışma Sayacı</Text>
                <View style={styles.timerStatus}>
                  {isRunning && (
                    <View style={styles.runningIndicator}>
                      <Text style={styles.runningText}>Aktif</Text>
                    </View>
                  )}
                </View>
              </View>
              ...
              <View style={styles.timerControls}>
                ...
                >
                  <LinearGradient
                    colors={isRunning ? [Colors.error, '#FF6B6B'] : Colors.gradients.primary}
                ...
                {privateRooms.length === 0 && publicRooms.length === 0 && (
                  ...
                  >
                    <GradientCard colors={Colors.gradients.warmDark} style={styles.emptyCard}>
                      <Target size={48} color={Colors.text.secondary} style={styles.emptyIcon} />
                      <Text style={styles.emptyTitle}>Henüz hiç çalışma odası yok</Text>
...
const styles = StyleSheet.create({
  ...
  secondaryButton: {
    ...
    borderWidth: 1,
    borderColor: Colors.darkGray[700],
    gap: Spacing.xs,
  },
  buttonGradient: {
    flexDirection: 'row',
