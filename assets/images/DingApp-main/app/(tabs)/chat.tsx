        ...
        >
          ...
          <View style={styles.roomHeader}>
            <View style={styles.roomIconContainer}>
              {room.is_private ? (
                isProRoom ? (
                  <Crown size={20} color={Colors.medal.gold} />
                ) : (
            ...
            <View style={styles.roomStats}>
              ...
              {room.is_private && (
                <View style={styles.statItem}>
                  ...
                  <Text style={styles.statsText}>Şifreli</Text>
                </View>
              )}
            </View>
    ...
    <View style={styles.sectionContainer}>
      ...
      >
        ...
        <View style={styles.sectionBadge}>
          {isPrivate ? <Lock size={16} color={Colors.primary[400]} /> : <Hash size={16} color={Colors.success} />}
            ...
            <FlatList
              ...
              ListEmptyComponent={
                !filteredPublicRooms.length && !filteredPrivateRooms.length ? (
                  ...
                  >
                    <MessageSquare size={48} color={Colors.text.secondary} style={styles.emptyIcon} />
