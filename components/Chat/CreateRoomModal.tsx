...
import { X, Lock, MessageSquare } from 'lucide-react-native';
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={styles.title}>Yeni Sohbet Odası</Text>
          ...
          <Input
            ...
            leftIcon={<MessageSquare size={20} color={Colors.darkGray[400]} />}
          />
          ...
          >
            ...
            <Text style={styles.privateText}>Özel Oda</Text>
          </TouchableOpacity>
